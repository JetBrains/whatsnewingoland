...
// TODO: Migrate this to a Docker container.

// Step 1. Create a new Go Remote Run Configuration.
// Step 2. Copy the delve running command from there.
// Step 3. Use Search Everywhere and type: op in ter
// Step 4. Run the delve command from earlier in terminal.
//		   dlv debug --headless --listen=:2345 --api-version=2 --accept-multiclient
// Step 5. Run the Go Remote Run Configuration from earlier.
// Step 6. Terminate the debugger.
